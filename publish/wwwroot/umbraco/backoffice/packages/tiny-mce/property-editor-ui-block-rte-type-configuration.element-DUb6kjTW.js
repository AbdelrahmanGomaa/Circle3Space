...
import { UMB_BLOCK_RTE_TYPE as _ } from "@umbraco-cms/backoffice/block-rte";
...
let a = class extends b {
  constructor() {
    super(), d(this, i), d(this, p), this.value = [], y(this, p)?.destroy(), M(this, p, new U(this, R).addAdditionalPath(_).onSetup(() => ({ data: { entityType: _, preset: {} }, modal: { size: "large" } })).observeRouteBuilder((t) => {
      const e = t({});
...
//# sourceMappingURL=property-editor-ui-block-rte-type-configuration.element-DUb6kjTW.js.map
