import { UmbLanguageCollectionRepository as U } from "./language-collection.repository-didMva8o.js";
import { d as S } from "./language-access.workspace.context-token-ChA0uFUc.js";
...
var D = Object.defineProperty, G = Object.getOwnPropertyDescriptor, $ = (e) => {
  throw TypeError(e);
}, u = (e, t, n, h) => {
  for (var r = h > 1 ? void 0 : h ? G(t, n) : t, v = e.length - 1, m; v >= 0; v--)
    (m = e[v]) && (r = (h ? m(t, n, r) : m(r)) || r);
  return h && r && D(t, n, r), r;
}, b = (e, t, n) => t.has(e) || $("Cannot " + n), o = (e, t, n) => (b(e, t, "read from private field"), t.get(e)), l = (e, t, n) => t.has(e) ? $("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, n), y = (e, t, n, h) => (b(e, t, "write to private field"), t.set(e, n), n), i = (e, t, n) => (b(e, t, "access private method"), n), w, p, O, d, _, a, f, x, A, C, R, k, q, T, E;
let s = class extends N {
  constructor() {
    super(), l(this, a), this._languages = [], this._appLanguageIsReadOnly = !1, this._isOpen = !1, l(this, w, new U(this)), l(this, p), l(this, O), l(this, d), l(this, _), this._disallowedLanguages = [], this.consumeContext(S, (e) => {
      y(this, p, e), i(this, a, x).call(this);
...
x = async function() {
  o(this, p) && (this.observe(o(this, p).appLanguage, (e) => {
    this._appLanguage = e;
  }), this.observe(o(this, p).appLanguageReadOnlyState.isReadOnly, (e) => {
...
R = function(e) {
  o(this, p)?.setLanguage(e), this._isOpen = !1, this._popoverElement?.hidePopover();
};
k = function() {
  return g`<button id="toggle" data-mark="action:open" popovertarget="dropdown-popover">
			<span
				>${this._appLanguage?.name}
				${this._appLanguageIsReadOnly ? i(this, a, E).call(this, this._appLanguage?.unique) : L}</span
			>
  ...
  return g` <uui-popover-container
    ...
    (e) => g`
						<uui-menu-item
							...
							${i(this, a, T).call(this, e.unique) ? i(this, a, E).call(this, e.unique) : L}
						</uui-menu-item>
					`
  )}
			</umb-popover-layout>
...
//# sourceMappingURL=app-language-select.element-7W1nDVwa.js.map
