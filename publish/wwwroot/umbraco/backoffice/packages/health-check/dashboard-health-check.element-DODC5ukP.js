import { a as C } from "./health-check-dashboard.context-C1YcFqcZ.js";
...
let o = class extends U {
  constructor() {
    super(), p(this, h), this._routes = [
      {
        path: "/:groupName",
        component: () => import("./health-check-group.element-CO75WwNV.js"),
        setup: (e, t) => {
          const a = e;
      ...
      {
        path: "",
        component: () => import("./health-check-overview.element-7Jx6TDDb.js")
      },
      {
        path: "**",
      ...
      const { data: e } = await g(this, E.getHealthCheckGroup({ skip: 0, take: 9999 }));
      if (!e) return;
...
_ = function(e) {
  return e.map((t) => ({
    ...
    api: () => import("./health-check-dashboard.context-C1YcFqcZ.js").then((a) => a.h),
    weight: 500,
    meta: {
      label: t.name || ""
    }
...
//# sourceMappingURL=dashboard-health-check.element-DODC5ukP.js.map
