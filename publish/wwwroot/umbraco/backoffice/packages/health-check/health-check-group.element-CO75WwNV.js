import { U as w } from "./health-check-dashboard.context-C1YcFqcZ.js";
...
let l = class extends g {
  async _onActionClick(e) {
    ...
    const { error: t } = await R(
      this,
      S.postHealthCheckExecuteAction({ requestBody: this.action })
    );
    if (t) {
...
var A = Object.defineProperty, H = Object.getOwnPropertyDescriptor, y = (e) => {
  throw TypeError(e);
}, p = (e, t, i, o) => {
  for (var a = o > 1 ? void 0 : o ? H(t, i) : t, n = e.length - 1, c; n >= 0; n--)
    (c = e[n]) && (a = (o ? c(t, i, a) : c(a)) || a);
  return o && a && A(t, i, a), a;
...
//# sourceMappingURL=health-check-group.element-CO75WwNV.js.map
