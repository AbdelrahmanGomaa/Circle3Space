  ...
  return e ? c`
			<div
				...
				<div class="items">
					${g(
    e?.data.length === 0,
    () => c`<em><umb-localize key="toolbar_emptyGroup">Empty</umb-localize></em>`,
...
//# sourceMappingURL=property-editor-ui-tiptap-statusbar-configuration.element-CBp1IV7o.js.map
