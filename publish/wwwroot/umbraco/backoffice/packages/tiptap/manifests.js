...
const e = [
...
], o = [
  {
    ...
    element: () => import("./character-map-modal.element-KxxRqdRU.js")
  }
], n = [...e, ...o], p = [
  {
...
], b = [
  {
    ...
    name: "Table Tiptap Extension",
    api: () => import("./table.tiptap-toolbar-api-jgz_0rZb.js"),
    element: () => import("./table-toolbar-menu.element-ENAl4-mu.js"),
...
], T = [
  {
    ...
    manifest: {
      element: () => import("./tiptap-toolbar-button.element-Boria81H.js")
    }
  },
  {
    type: "kind",
    ...
    matchType: "tiptapToolbarExtension",
    manifest: {
      element: () => import("./tiptap-toolbar-color-picker-button.element-pI_N8ISQ.js")
    }
  },
  {
    type: "kind",
    ...
    matchType: "tiptapToolbarExtension",
    manifest: {
      element: () => import("./tiptap-toolbar-menu.element-Bowtq1j5.js")
    }
  },
  {
    type: "kind",
    ...
    matchType: "tiptapToolbarExtension",
    manifest: {
      api: () => import("./style-menu.tiptap-toolbar-api-pD-g0onj.js"),
      element: () => import("./tiptap-toolbar-menu.element-Bowtq1j5.js")
    }
  }
], d = [
  ...
  },
  {
    ...
    api: () => import("./text-color-background.tiptap-toolbar-api-CJzQImAh.js"),
    meta: {
  ...
  },
  {
    ...
    api: () => import("./text-color-foreground.tiptap-toolbar-api-DS-Z_lzh.js"),
    meta: {
  ...
  },
  {
    ...
    api: () => import("./anchor.tiptap-toolbar-api-MQ2MoNo5.js"),
    meta: {
      alias: "anchor",
      icon: "icon-anchor",
      label: "#tiptap_anchor"
  ...
  },
  {
    ...
    element: () => import("./tiptap-toolbar-button-disabled.element-7fPqrSFx.js"),
    forExtensions: ["Umb.Tiptap.Link"],
    meta: {
      alias: "unlink",
      icon: "icon-unlink",
  ...
  },
  {
    ...
    api: () => import("./embedded-media.tiptap-toolbar-api-BkKRK5Pc.js"),
  ...
  },
  {
    ...
    api: () => import("./font-family.tiptap-toolbar-api-Ed4I5rFX.js"),
    items: [
  ...
  },
  {
    ...
    api: () => import("./font-size.tiptap-toolbar-api-BPNtMF-H.js"),
    items: [
      { label: "8pt", data: "8pt;" },
  ...
  },
  {
    ...
    api: () => import("./character-map.tiptap-toolbar-api-BFIScrdB.js"),
    meta: {
...
], E = [
  {
    ...
    element: () => import("./property-editor-ui-tiptap.element-DLjFWhmC.js"),
    meta: {
...
_Drag and drop the available actions onto the statusbar areas._`,
  ...
  },
  {
    ...
    element: () => import("./property-editor-ui-tiptap-extensions-configuration.element-B-w8OLZG.js"),
    meta: {
  ...
  },
  {
    ...
    element: () => import("./property-editor-ui-tiptap-toolbar-configuration.element-okeG0GCY.js"),
    meta: {
  ...
  },
  {
    ...
    element: () => import("./property-editor-ui-tiptap-statusbar-configuration.element-CBp1IV7o.js"),
    meta: {
