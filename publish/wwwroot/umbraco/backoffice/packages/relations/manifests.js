import { m as i, c as a, U as n } from "./bulk-trash-with-relation.action.kind-KJodVnkL.js";
...
const R = [
...
], I = [a, ...d], _ = [
  {
    ...
    api: () => import("./relation-collection.repository-sXWDJhuS.js").then((e) => e.r)
  }
], A = [..._], h = {
  type: "kind",
  ...
  manifest: {
    ...
    element: () => import("./entity-references-workspace-view-info.element-DpPKmMO9.js"),
    weight: 90
  }
}, k = [U], N = [
  ...y,
