import { U as i } from "./block-catalogue-modal.element-1MlNjslD.js";
import { UmbBasicState as o, UmbStringState as h, UmbArrayState as l } from "@umbraco-cms/backoffice/observable-api";
import { UmbContextBase as u } from "@umbraco-cms/backoffice/class-api";
class c extends u {
  constructor(t, e) {
    super(t, i.toString()), this._catalogueRouteBuilderState = new o(void 0), this.catalogueRouteBuilder = this._catalogueRouteBuilderState.asObservable(), this._workspacePath = new h(void 0), this.workspacePath = this._workspacePath.asObservable(), this._layoutEntries = new l([], (a) => a.contentKey), this.layoutEntries = this._layoutEntries.asObservable(), this.layoutEntriesLength = this._layoutEntries.asObservablePart((a) => a.length), this._retrieveManager = this.consumeContext(e, (a) => {
...
//# sourceMappingURL=block-entries.context-CSSvS_hC.js.map
