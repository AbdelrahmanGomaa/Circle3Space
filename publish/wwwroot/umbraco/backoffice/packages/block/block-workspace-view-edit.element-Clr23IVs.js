...
import { UmbContentTypeContainerStructureHelper as M } from "@umbraco-cms/backoffice/content-type";
...
let r = class extends S {
  constructor() {
    super(), m(this, c), m(this, h), m(this, i), m(this, p, new M(this)), this._hasRootGroups = !1, this._routes = [], this._activePath = "", a(this, p).setIsRoot(!0), a(this, p).setContainerChildType("Tab"), this.observe(
...
y = function() {
  ...
  this._tabs.length > 0 && this._tabs?.forEach((e) => {
    ...
    t.push({
      path: `tab/${P(s)}`,
      component: () => import("./block-workspace-view-edit-tab.element-OxvfYXwJ.js"),
      setup: (o) => {
...
//# sourceMappingURL=block-workspace-view-edit.element-Clr23IVs.js.map
