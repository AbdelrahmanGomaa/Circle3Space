...
import { c as kt, b as wt, d as Ct } from "../index-D4Ltu24Y.js";
import { UmbContextToken as w } from "@umbraco-cms/backoffice/context-api";
import { UmbBlockEntryContext as F, UMB_BLOCK_ENTRY_CONTEXT as H, UmbDataPathBlockElementDataQuery as O, UmbBlockEntriesContext as Y, UMB_BLOCK_CATALOGUE_MODAL as z, UmbBlockManagerContext as G } from "@umbraco-cms/backoffice/block";
...
}, I = (t, e, o) => e.has(t) || x("Cannot " + o), n = (t, e, o) => (I(t, e, "read from private field"), o ? o.call(t) : e.get(t)), E = (t, e, o) => e.has(t) ? x("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, o), c = (t, e, o) => (I(t, e, "access private method"), o), r, a, d, A, B, g, T, V, L, K, D;
let l = class extends M {
  constructor() {
    super(), E(this, a), E(this, r, new Z(this)), this._showContentEdit = !1, this._hasSettings = !1, this._label = "", this._blockViewProps = {
      ...
      n(this, r).expose();
    }), E(this, T, (t) => this._exposed ? t.component : _`<div>
				${t.component}
...
class mt extends Y {
  constructor(e) {
    super(e, U), this.canCreate = new q(!0).asObservable(), new $(this, z).addAdditionalPath("_catalogue/:view").onSetup((o) => ({
      data: {
