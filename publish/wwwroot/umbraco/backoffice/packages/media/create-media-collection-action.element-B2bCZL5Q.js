import { s as U, h as w, u as C } from "./input-upload-field.element-B7PCDmnx.js";
import { U as d, a as O } from "./media-item.store.context-token-9YLCPlu1.js";
...
var $ = Object.defineProperty, D = Object.getOwnPropertyDescriptor, y = (e) => {
  ...
  return p && n && $(t, i, n), n;
}, T = (e, t, i) => t.has(e) || y("Cannot " + i), I = (e, t, i) => (T(e, t, "read from private field"), i ? i.call(e) : t.get(e)), f = (e, t, i) => t.has(e) ? y("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), l = (e, t, i) => (T(e, t, "access private method"), i), _, a, v, b, m, E, M;
let o = class extends B {
  constructor() {
    super(), f(this, a), this._allowedMediaTypes = [], this._popoverOpen = !1, f(this, _, new g(this)), this.consumeContext(U, (e) => {
...
m = function(e) {
  return e.unique && this._workspacePathBuilder ? this._workspacePathBuilder({ entityType: d }) + C.generateLocal({
    parentEntityType: this._mediaUnique ? d : O,
...
M = function() {
  ...
  return h`
    ...
    (t) => h`
								<uui-menu-item label=${t.name} href=${l(this, a, m).call(this, t)}>
...
//# sourceMappingURL=create-media-collection-action.element-B2bCZL5Q.js.map
