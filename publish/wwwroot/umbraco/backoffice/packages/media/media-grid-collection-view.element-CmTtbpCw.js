import { h as q, v as I } from "./input-upload-field.element-B7PCDmnx.js";
import { b as M } from "./media-item.store.context-token-9YLCPlu1.js";
...
var A = Object.defineProperty, B = Object.getOwnPropertyDescriptor, y = (e) => {
  throw TypeError(e);
}, d = (e, t, i, c) => {
...
P = function(e) {
  return e.unique && this._workspacePathBuilder ? this._workspacePathBuilder({ entityType: e.entityType }) + I.generateLocal({
    unique: e.unique
  }) : "";
};
$ = function(e) {
...
//# sourceMappingURL=media-grid-collection-view.element-CmTtbpCw.js.map
