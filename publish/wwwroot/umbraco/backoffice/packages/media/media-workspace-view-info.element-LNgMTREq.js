import { s as S } from "./input-upload-field.element-B7PCDmnx.js";
import { T } from "./utils-Cn_XY6oh.js";
import { html as m, ifDefined as g, nothing as y, css as w, state as n, customElement as x } from "@umbraco-cms/backoffice/external/lit";
...
}, f = (e, t, i) => t.has(e) || b("Cannot " + i), l = (e, t, i) => (f(e, t, "read from private field"), i ? i.call(e) : t.get(e)), h = (e, t, i) => t.has(e) ? b("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), B = (e, t, i, d) => (f(e, t, "write to private field"), t.set(e, i), i), c = (e, t, i) => (f(e, t, "access private method"), i), p, v, r, I, U, D, M, E;
let a = class extends A {
  constructor() {
    super(), h(this, r), this._mediaTypeUnique = void 0, this._editMediaTypePath = "", this._mediaUnique = "", h(this, p), h(this, v, new z(this)), this._createDate = null, this._updateDate = null, this._hasSettingsAccess = !1, new $(this, O).addAdditionalPath("media-type").onSetup(() => ({ data: { entityType: C, preset: {} } })).observeRouteBuilder((e) => {
      ...
      B(this, p, e), this._mediaTypeUnique = l(this, p).getContentTypeId(), c(this, r, I).call(this), c(this, r, U).call(this);
    });
  }
  render() {
    return m`
...
I = async function() {
  ...
  const { data: e } = await l(this, v).requestItems([this._mediaTypeUnique]);
  this._mediaTypeName = e?.[0].name, this._mediaTypeIcon = e?.[0].icon;
};
U = function() {
  l(this, p) && (this.observe(
    l(this, p).unique,
    (e) => {
      this._mediaUnique = e;
    },
    "_mediaUnique"
  ), this.observe(l(this, p).variants, (e) => {
    this._createDate = e?.[0]?.createDate, this._updateDate = e?.[0]?.updateDate;
  }));
};
D = function() {
  return m`
			${c(this, r, M).call(this)} ${c(this, r, E).call(this)}
    ...
    this._hasSettingsAccess ? this._editMediaTypePath + "edit/" + this._mediaTypeUnique : void 0
					...
					${this._mediaTypeIcon ? m`<umb-icon slot="icon" name=${this._mediaTypeIcon}></umb-icon>` : y}
				</uui-ref-node-document-type>
			</div>
			<div class="general-item">
...
a = s([
  x("umb-media-workspace-view-info")
], a);
const j = a;
export {
...
//# sourceMappingURL=media-workspace-view-info.element-LNgMTREq.js.map
