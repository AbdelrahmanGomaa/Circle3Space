import { h as U, v as x } from "./input-upload-field.element-B7PCDmnx.js";
...
}, y = (e, t, s) => t.has(e) || S("Cannot " + s), c = (e, t, s) => (y(e, t, "read from private field"), t.get(e)), f = (e, t, s) => t.has(e) ? S("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, s), K = (e, t, s, a) => (y(e, t, "write to private field"), t.set(e, s), s), l = (e, t, s) => (y(e, t, "access private method"), s), m, o, r, A, g, w, O, M, I, B;
let n = class extends D {
  constructor() {
    ...
    ]), this._tableItems = [], this._selection = [], f(this, o), this.consumeContext(U, (e) => {
...
w = function() {
  this._tableItems = [], this._items !== void 0 && this._workspacePathBuilder !== void 0 && (this._tableColumns.length === 0 && l(this, r, g).call(this), this._tableItems = this._items.map((e) => {
    ...
    const t = this._tableColumns?.map((s) => {
      ...
      const a = e.unique && this._workspacePathBuilder ? this._workspacePathBuilder({ entityType: e.entityType }) + x.generateLocal({
        unique: e.unique
      }) : "";
      return {
        columnAlias: s.alias,
...
//# sourceMappingURL=media-table-collection-view.element-BEBPXjUu.js.map
