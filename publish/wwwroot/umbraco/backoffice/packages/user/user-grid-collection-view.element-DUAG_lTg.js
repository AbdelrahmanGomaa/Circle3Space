...
import { h as x, U as T } from "./constants-BstfLIKC.js";
...
import { U as D } from "./paths-z-la_6QN.js";
...
}, g = (e, t, i) => t.has(e) || y("Cannot " + i), c = (e, t, i) => (g(e, t, "read from private field"), i ? i.call(e) : t.get(e)), m = (e, t, i) => t.has(e) ? y("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), C = (e, t, i, o) => (g(e, t, "write to private field"), t.set(e, i), i), a = (e, t, i) => (g(e, t, "access private method"), i), d, r, U, s, b, w, E, S, z, k, G;
let u = class extends R {
  constructor() {
    super(), m(this, s), this._users = [], this._selection = [], this._loading = !1, m(this, d, []), m(this, r), m(this, U, new N(this)), this.consumeContext(x, (e) => {
      ...
      ), this.observe(c(this, r).items, (t) => this._users = t, "umbCollectionItemsObserver");
...
b = async function() {
  this._loading = !0;
  const { data: e } = await c(this, U).requestCollection();
  C(this, d, e?.items ?? []), this._loading = !1;
};
w = function(e) {
  c(this, r)?.selection.select(e.unique ?? "");
};
E = function(e) {
  c(this, r)?.selection.deselect(e.unique ?? "");
};
S = function(e) {
  return l`
			<uui-card-user
				...
				?selected=${c(this, r)?.selection.isSelected(e.unique)}
...
k = function(e) {
  const t = c(this, d).filter((i) => e.userGroupUniques?.map((o) => o.unique).includes(i.unique)).map((i) => i.name).join(", ");
  return l`<div>${t}</div>`;
};
G = function(e) {
...
const ne = u;
export {
  u as UmbUserGridCollectionViewElement,
  ne as default,
  u as element
};
//# sourceMappingURL=user-grid-collection-view.element-DUAG_lTg.js.map
