...
import { U as w } from "./user.repository-DqW-ltjf.js";
...
var W = Object.defineProperty, D = Object.getOwnPropertyDescriptor, y = (e) => {
  ...
  for (var a = i > 1 ? void 0 : i ? D(t, r) : t, o = e.length - 1, s; o >= 0; o--)
    (s = e[o]) && (a = (i ? s(t, r, a) : s(a)) || a);
  return i && a && W(t, r, a), a;
...
_ = async function() {
  const e = (await p(this, c).requestMfaProviders(p(this, u))).asObservable(), t = L.byType("mfaLoginProvider"), r = T(
    ...
    ([i, a]) => a.map((o) => {
      const s = i.find(
        ($) => $.providerName === o.forProviderName
      );
      return {
        existsOnServer: !!s,
        isEnabledOnUser: s?.isEnabledOnUser ?? !1,
        providerName: s?.providerName ?? o.forProviderName,
        displayName: o.meta?.label ?? s?.providerName ?? o.name
      };
    })
  );
  this.observe(
...
//# sourceMappingURL=user-mfa-modal.element-a3qEXT9V.js.map
