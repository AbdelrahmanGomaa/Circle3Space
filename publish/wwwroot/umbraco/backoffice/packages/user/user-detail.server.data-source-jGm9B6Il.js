import { U as o, d as u } from "./constants-BstfLIKC.js";
...
class h {
  ...
  async read(e) {
    ...
    const { data: t, error: s } = await i(this.#e, n.getUserById({ id: e }));
...
//# sourceMappingURL=user-detail.server.data-source-jGm9B6Il.js.map
