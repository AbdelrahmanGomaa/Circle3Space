import { h as A, U as D } from "./constants-BstfLIKC.js";
...
import { UmbUserGroupItemRepository as R } from "@umbraco-cms/backoffice/user-group";
import { U as W } from "./paths-z-la_6QN.js";
import { g as $ } from "./utils-BEu6TUZg.js";
var j = Object.defineProperty, V = Object.getOwnPropertyDescriptor, f = (e, t, s, r) => {
  for (var a = r > 1 ? void 0 : r ? V(t, s) : t, o = e.length - 1, i; o >= 0; o--)
    (i = e[o]) && (a = (r ? i(t, s, a) : i(a)) || a);
  return r && a && j(t, s, a), a;
};
let p = class extends O {
  render() {
    const e = W + "/edit/" + this.value.unique;
...
}, U = (e, t, s) => t.has(e) || P("Cannot " + s), b = (e, t, s) => (U(e, t, "read from private field"), s ? s.call(e) : t.get(e)), d = (e, t, s) => t.has(e) ? P("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, s), H = (e, t, s, r) => (U(e, t, "write to private field"), t.set(e, s), s), c = (e, t, s) => (U(e, t, "access private method"), s), C, u, l, I, E, G, T, q, L;
let n = class extends M {
  constructor() {
    ...
    ], this._tableItems = [], this._userGroupItems = [], d(this, C, new R(this)), this._users = [], this._selection = [], d(this, u), this.consumeContext(A, (e) => {
...
//# sourceMappingURL=user-table-collection-view.element-CnAWlqtC.js.map
