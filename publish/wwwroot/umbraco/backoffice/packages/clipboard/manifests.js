import { k as a, e as t, l as n, U as i, f as s, a as e, b as p, h as l, j as r, n as m, d as c, c as o } from "./manifests-B_tP43dQ.js";
...
const d = [
...
], T = [
  {
    ...
    api: () => import("./clipboard.context-D33lg8eo.js")
  }
], b = [
  {
    type: "repository",
    ...
    api: () => import("./clipboard-entry-detail.repository-DNY6xznx.js")
  },
  {
    type: "store",
    alias: s,
    name: "Clipboard Detail Store",
    api: () => import("./clipboard-entry-detail.store-6CktDmk0.js")
  },
  {
    type: "entityAction",
    kind: "delete",
...
], O = [
  {
    ...
    api: () => import("./clipboard-entry-item.repository-YidWJ5pP.js")
  },
  {
    type: "itemStore",
    alias: l,
    name: "Clipboard Entry Item Store",
    api: () => import("./clipboard-entry-item.store-ChtaE1YO.js")
  }
], R = [
  {
    type: "modal",
...
], f = [...L, ...m], B = [
  {
    ...
    manifest: {
      ...
      kind: "clipboard",
      api: () => import("./clipboard.property-context-DMkEcszu.js"),
      weight: 1200
    }
  }
], D = [
