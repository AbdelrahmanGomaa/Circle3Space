import { c as w, m as A } from "./constants-CrVNO8d3.js";
...
var D = Object.defineProperty, S = Object.getOwnPropertyDescriptor, T = (e) => {
  ...
  for (var i = o > 1 ? void 0 : o ? S(n, t) : n, c = e.length - 1, _; c >= 0; c--)
    (_ = e[c]) && (i = (o ? _(n, t, i) : _(i)) || i);
  return o && i && D(n, t, i), i;
}, d = (e, n, t) => n.has(e) || T("Cannot " + t), h = (e, n, t) => (d(e, n, "read from private field"), n.get(e)), p = (e, n, t) => n.has(e) ? T("Cannot add the same private member more than once") : n instanceof WeakSet ? n.add(e) : n.set(e, t), f = (e, n, t, o) => (d(e, n, "write to private field"), n.set(e, t), t), v = (e, n, t) => (d(e, n, "access private method"), t), l, m, s, y, E, C;
...
C = function(e) {
  ...
  this._tableItems = e.map((t) => {
    const o = n({ entityType: t.entityType }) + w.generateLocal({ unique: t.unique }), i = A.generateAbsolute({
      unique: t.unique
    });
    return {
      id: t.unique,
...
//# sourceMappingURL=document-type-tree-item-table-collection-view.element-DwKrXr6h.js.map
