import { U as k } from "./document-audit-log.repository-CHm64Rly.js";
import { g as I } from "./manifests-BUr6Ff2j.js";
...
var z = Object.defineProperty, Y = Object.getOwnPropertyDescriptor, P = (t) => {
  ...
  for (var i = l > 1 ? void 0 : l ? Y(e, a) : e, y = t.length - 1, f; y >= 0; y--)
    (f = t[y]) && (i = (l ? f(e, a, i) : f(i)) || i);
  return l && i && z(e, a, i), i;
}, E = (t, e, a) => e.has(t) || P("Cannot " + a), r = (t, e, a) => (E(t, e, "read from private field"), a ? a.call(t) : e.get(t)), u = (t, e, a) => e.has(t) ? P("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, a), G = (t, e, a, l) => (E(t, e, "write to private field"), e.set(t, a), a), c = (t, e, a) => (E(t, e, "access private method"), a), b, v, n, S, m, _, o, N, h, U, A, C;
let d = class extends D {
  constructor() {
    super(), u(this, o), u(this, b, /* @__PURE__ */ new Set(["Umb.EntityAction.Document.Rollback"])), u(this, v, new k(this)), u(this, n, new B()), u(this, S, new H(this)), u(this, m, /* @__PURE__ */ new Map()), u(this, _), this._currentPageNumber = 1, this._items = [], this._totalPages = 1, r(this, n).setPageSize(10), this.observe(r(this, n).currentPage, (t) => this._currentPageNumber = t), this.observe(r(this, n).totalPages, (t) => this._totalPages = t), this.consumeContext(q, (t) => {
    ...
    return p`
			<umb-workspace-info-app-layout headline="#general_history">
				<umb-extension-with-api-slot
					slot="header-actions"
					type="entityAction"
					.filter=${(t) => r(this, b).has(t.alias)}></umb-extension-with-api-slot>
...
N = function(t) {
  r(this, n).setCurrentPageNumber(t.target?.current), c(this, o, h).call(this);
};
h = async function() {
  const t = r(this, _)?.getUnique();
  ...
  e && (this._items = e.items, r(this, n).setTotalItems(e.total), c(this, o, U).call(this));
};
U = async function() {
  const t = this._items?.map((i) => i.user.unique).filter(Boolean), a = [...new Set(t)].filter((i) => !r(this, m).has(i));
  if (a.length === 0) return;
  const { data: l } = await r(this, S).requestItems(a);
  l && l.forEach((i) => {
    r(this, m).set(i.unique, i), this.requestUpdate("_items");
  });
};
A = function() {
  return this._items?.length ? p`
    ...
    (t) => t.timestamp,
    (t) => {
      const { text: e, style: a } = W(t.logType), l = r(this, m).get(t.user.unique);
      return p`
							<umb-history-item
								.name=${l?.name ?? "Unknown"}
...
//# sourceMappingURL=document-history-workspace-info-app.element-D1zosFX4.js.map
