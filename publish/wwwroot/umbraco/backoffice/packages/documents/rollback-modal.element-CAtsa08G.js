import { d as T } from "./manifests-BUr6Ff2j.js";
import { UmbRollbackRepository as X } from "./rollback.repository-ClykyB0k.js";
import { UmbDocumentDetailRepository as Y } from "./document-detail.repository-kH54fJDj.js";
import "@umbraco-cms/backoffice/repository";
import "@umbraco-cms/backoffice/external/backend-api";
import "@umbraco-cms/backoffice/resources";
import { diffWords as U } from "@umbraco-cms/backoffice/external/diff";
...
}, V = (e, t, i) => t.has(e) || I("Cannot " + i), u = (e, t, i) => (V(e, t, "read from private field"), t.get(e)), p = (e, t, i) => t.has(e) ? I("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), C = (e, t, i, r) => (V(e, t, "write to private field"), t.set(e, i), i), o = (e, t, i) => (V(e, t, "access private method"), i), m, k, _, d, y, g, l, v, E, $, D, P, M, R, N, x, S, O, A, B;
let h = class extends j {
  constructor() {
    super(), p(this, l), this._versions = [], this._selectedCulture = null, this._isInvariant = !0, this._availableVariants = [], this._diffs = [], p(this, m, new X(this)), p(this, k, new Q(this)), p(this, _, {
      day: "numeric",
      month: "long",
      hour: "numeric",
      minute: "2-digit"
    }), p(this, d), p(this, y), p(this, g), this.consumeContext(K, (e) => {
      ...
      })) : this._availableVariants = [], o(this, l, E).call(this);
    });
  }
...
E = async function() {
  ...
  if (!e) return;
  const t = [], i = [...new Set(e?.items.map((a) => a.user.id))], { data: r } = await u(this, k).requestItems(i);
  e?.items.forEach((a) => {
...
D = async function() {
  ...
  const a = await this.getContext(re), n = new se({ unique: r, entityType: s });
  a.dispatchEvent(n);
...
N = function(e) {
  ...
  this._selectedCulture = t.toString(), o(this, l, E).call(this);
};
x = function(e) {
  return e.replace(/^['"]|['"]$/g, "");
};
...
//# sourceMappingURL=rollback-modal.element-CAtsa08G.js.map
