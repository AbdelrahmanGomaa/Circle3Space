import { UmbDocumentItemRepository as S } from "./document-item.repository-DGfmiV4g.js";
import "@umbraco-cms/backoffice/external/backend-api";
import "@umbraco-cms/backoffice/class-api";
import "@umbraco-cms/backoffice/language";
import "@umbraco-cms/backoffice/observable-api";
import "@umbraco-cms/backoffice/property";
import { when as $, html as r, repeat as E, css as k, state as f, customElement as q } from "@umbraco-cms/backoffice/external/lit";
...
import { UMB_CREATE_DOCUMENT_WORKSPACE_PATH_PATTERN as x, UMB_CREATE_FROM_BLUEPRINT_DOCUMENT_WORKSPACE_PATH_PATTERN as I } from "@umbraco-cms/backoffice/document";
...
let l = class extends U {
  constructor() {
    super(...arguments), u(this, n), u(this, g, new P(this)), u(this, T, new S(this)), u(this, v, new W(this)), u(this, c, ""), u(this, d, ""), this._allowedDocumentTypes = [], this._headline = `${this.localize.term("create_createUnder")} ${this.localize.term("actionCategories_content")}`, this._availableBlueprints = [];
  }
  async firstUpdated() {
...
//# sourceMappingURL=document-create-options-modal.element-DdpqvmWb.js.map
