...
import { UmbManagementApiDataMapper as p } from "@umbraco-cms/backoffice/repository";
class y extends s {
  #e = new p(this);
  /**
  ...
  async getReferencedBy(e, r = 0, t = 20) {
    const { data: a, error: i } = await f(
      this,
      d.getDataTypeByIdReferencedBy({ id: e, skip: r, take: t })
    );
    if (a) {
...
//# sourceMappingURL=data-type-reference.repository-KSzcjL7V.js.map
