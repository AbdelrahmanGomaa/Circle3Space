import { n as J, b as V, f as Z, q as tt, g as et } from "./constants-hBehNVbJ.js";
import { UmbDataTypeCollectionRepository as it } from "./data-type-collection.repository-CRUwr960.js";
import { html as n, nothing as b, when as x, repeat as z, css as at, state as v, customElement as rt } from "@umbraco-cms/backoffice/external/lit";
...
}, w = (t, e, i) => e.has(t) || B("Cannot " + i), s = (t, e, i) => (w(t, e, "read from private field"), e.get(t)), h = (t, e, i) => e.has(t) ? B("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, i), d = (t, e, i, l) => (w(t, e, "write to private field"), e.set(t, i), i), r = (t, e, i) => (w(t, e, "access private method"), i), y, T, C, u, m, E, _, a, $, N, S, W, P, L, Y, M, k, D, F, I, q, K, j, U, G, X, A, H;
...
N = async function() {
  this.pagination.setCurrentPageNumber(1), this.pagination.setPageSize(100), d(this, y, Promise.all([
    this.observe(ot.byType("propertyEditorUi"), (t) => {
      d(this, _, t.filter((e) => !!e.meta.propertyEditorSchemaAlias).sort((e, i) => e.meta.label.localeCompare(i.meta.label))), d(this, E, Object.fromEntries(t.map((e) => [e.alias, e.meta.group]))), r(this, a, D).call(this);
    }).asPromise()
    ...
    const e = this.consumeContext(ht, () => {
      this.removeUmbController(e);
    }).passContextAliasMatches(), i = this.consumeContext(dt, () => {
      this.removeUmbController(i);
    }).passContextAliasMatches(), [l, o] = await Promise.all([
      e.asPromise(),
      i.asPromise(),
      s(this, y)
    ]), c = s(this, _).find((Q) => Q.alias === t.uiAlias)?.name, g = `${l?.getName() ?? ""} - ${o.getName() ?? ""} - ${c}`;
    return {
      data: {
        entityType: Z,
...
M = /* @__PURE__ */ new WeakMap();
k = async function() {
  await r(this, a, S).call(this), r(this, a, D).call(this);
};
D = function() {
  if (s(this, u)) {
...
F = function() {
  return s(this, u) ? r(this, a, q).call(this) : r(this, a, U).call(this);
};
I = function() {
  return n` <uui-input
			type="search"
...
//# sourceMappingURL=data-type-picker-flow-modal.element-BAQJaJYb.js.map
