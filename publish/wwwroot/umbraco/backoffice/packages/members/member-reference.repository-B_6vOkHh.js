...
class p extends f {
  ...
  async getReferencedBy(e, t = 0, n = 20) {
    const { data: r, error: a } = await d(
      this,
      c.getMemberByIdReferencedBy({ id: e, skip: t, take: n })
    );
    if (r) {
  ...
  async getAreReferenced(e, t = 0, n = 20) {
    const { data: r, error: a } = await d(
      this,
      c.getMemberAreReferenced({ id: e, skip: t, take: n })
    );
  ...
  async getReferencedDescendants(e, t = 0, n = 20) {
    const { data: r, error: a } = await d(
      this,
      c.getMemberByIdReferencedDescendants({ id: e, skip: t, take: n })
    );
    return r ? { data: { items: r.items.map((s) => ({
      unique: s.id,
      entityType: m
...
//# sourceMappingURL=member-reference.repository-B_6vOkHh.js.map
