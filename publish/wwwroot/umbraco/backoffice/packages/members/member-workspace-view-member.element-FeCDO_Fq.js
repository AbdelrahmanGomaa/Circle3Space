import { u as M } from "./manifests-BeI4zfAH.js";
...
}, T = (e, t, r) => t.has(e) || N("Cannot " + r), _ = (e, t, r) => (T(e, t, "read from private field"), r ? r.call(e) : t.get(e)), $ = (e, t, r) => t.has(e) ? N("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r), te = (e, t, r, l) => (T(e, t, "write to private field"), t.set(e, r), r), C = (e, t, r) => (T(e, t, "access private method"), r), m, x, v, z, O;
...
}, q = (e, t, r) => t.has(e) || I("Cannot " + r), y = (e, t, r) => (q(e, t, "read from private field"), r ? r.call(e) : t.get(e)), P = (e, t, r) => t.has(e) ? I("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r), p = (e, t, r) => (q(e, t, "access private method"), r), o, b, R, w, E, L, W, F;
let c = class extends U {
  constructor() {
    super(), P(this, o), this._showChangePasswordForm = !1, this._newPasswordError = "", this._isNew = !0, this._hasAccessToSensitiveData = !1, P(this, w, () => {
  ...
  render() {
    return n`
			<umb-body-layout header-fit-height>
				<div id="main">${p(this, o, W).call(this)} ${p(this, o, F).call(this)}</div>
			</umb-body-layout>
		`;
  }
};
				...
				<uui-box>
					<umb-property-layout label=${this.localize.term("general_username")} mandatory>
						<uui-input
							...
							@input=${(e) => p(this, o, b).call(this, "username", e.target.value)}></uui-input>
					</umb-property-layout>
					...
					<umb-property-layout label=${this.localize.term("general_email")} mandatory>
						<uui-input
							...
							@input=${(e) => p(this, o, b).call(this, "email", e.target.value)}></uui-input>
					</umb-property-layout>

					${p(this, o, L).call(this)}
      ...
      () => n`
							<umb-property-layout label=${this.localize.term("user_stateApproved")}>
								<uui-toggle
									...
									@change=${(e) => p(this, o, b).call(this, "isApproved", e.target.checked)}>
								</uui-toggle>
							</umb-property-layout>
							...
							<umb-property-layout label=${this.localize.term("user_stateLockedOut")}>
								<uui-toggle
									...
									@change=${(e) => p(this, o, b).call(this, "isLockedOut", e.target.checked)}>
								</uui-toggle>
							</umb-property-layout>
						`
    )}
					<umb-property-layout label=${this.localize.term("member_2fa")}>
						<uui-toggle
							...
							@change=${(e) => p(this, o, b).call(this, "isTwoFactorEnabled", e.target.checked)}>
						</uui-toggle>
					</umb-property-layout>
				</uui-box>
...
//# sourceMappingURL=member-workspace-view-member.element-FeCDO_Fq.js.map
