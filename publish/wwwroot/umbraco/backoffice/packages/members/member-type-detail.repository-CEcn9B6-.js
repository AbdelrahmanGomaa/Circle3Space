...
import { j as l } from "./input-member-type.element-Kmg-HeuV.js";
...
class d {
  ...
  async read(i) {
    ...
    const { data: a, error: s } = await r(this.#e, t.getMemberTypeById({ id: i }));
...
//# sourceMappingURL=member-type-detail.repository-CEcn9B6-.js.map
