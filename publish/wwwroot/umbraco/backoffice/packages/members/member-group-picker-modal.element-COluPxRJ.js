...
import { tryExecuteAndNotify as ae } from "@umbraco-cms/backoffice/resources";
...
class Me {
  ...
  async getCollection(t) {
    const { data: r, error: n } = await ae(this.#e, le.getMemberGroup(t));
    if (n)
      return { error: n };
    if (!r)
...
//# sourceMappingURL=member-group-picker-modal.element-COluPxRJ.js.map
