...
import { TelemetryLevelModel as l, TelemetryService as c, ApiError as v } from "@umbraco-cms/backoffice/external/backend-api";
...
var g = Object.defineProperty, f = Object.getOwnPropertyDescriptor, i = (t, e, m, a) => {
  for (var s = a > 1 ? void 0 : a ? f(e, m) : e, n = t.length - 1, y; n >= 0; n--)
    (y = t[n]) && (s = (a ? y(e, m, s) : y(s)) || s);
  return a && s && g(e, m, s), s;
};
let r = class extends b {
  ...
  async _setup() {
    const t = await u(this, c.getTelemetry({ skip: 0, take: 3 }));
...
//# sourceMappingURL=dashboard-telemetry.element-CUd6LCSi.js.map
