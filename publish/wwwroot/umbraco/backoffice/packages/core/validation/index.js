import { css as L, property as E, customElement as B, repeat as S, unsafeHTML as N, html as x, directive as j, AsyncDirective as Y, nothing as P } from "@umbraco-cms/backoffice/external/lit";
...
import { UmbArrayState as W, createObservablePart as m, UmbObjectState as q, defaultMemoization as H, simpleHashCode as J } from "@umbraco-cms/backoffice/observable-api";
...
class rt extends u {
  constructor(t) {
    super(t), this.#t = !1, this.#i = new q(void 0), this.#s = [], this.#e = !1, this.#a = !1, this.messages = new st(), this.#m = (e) => {
      if (this.#n) {
  ...
  */
  ...
  destroy() {
    this.#e = !1, this.#t !== !0 && (this.#g(), this.unprovide(), this.messages?.destroy(), this.messages = void 0, this.#n && this.#n.removeValidator(this), this.#d = void 0, this.#h = void 0, this.#n = void 0, super.destroy());
  }
}
class It extends rt {
  constructor(t) {
...
class Ft extends u {
  ...
  async translateProperty(t, e) {
    ...
    return n && (t = await n.translate(t, e) ?? t), t;
  }
}
class $t extends Q {
  #r = [];
  ...
  async askServerForValidation(t, e) {
    ...
    if (this.#a = !i, this.#a)
      ...
      let s = [];
      const n = i.body;
      if (n?.errors && Object.keys(n.errors).forEach((a) => {
        const o = n.errors[a];
...
class ct extends u {
  ...
  #e(t) {
    this.#s !== t && (this.#s = t, this.#r && (t ? this.#t?.messages.removeMessagesByTypeAndPath("client", this.#r) : this.#t?.messages.addMessages("client", this.#r, [this.#i.validationMessage])));
  }
