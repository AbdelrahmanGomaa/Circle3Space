...
let n = class extends K {
  constructor() {
    super(), y(this, a), y(this, d), this._customValidationOptions = [
      ...
      this.observe(e.variesByCulture, (t) => this._contentTypeVariesByCulture = t), this.observe(e.variesBySegment, (t) => this._contentTypeVariesBySegment = t), this._entityType = e.getEntityType();
...
//# sourceMappingURL=property-workspace-view-settings.element-COlsEmAw.js.map
