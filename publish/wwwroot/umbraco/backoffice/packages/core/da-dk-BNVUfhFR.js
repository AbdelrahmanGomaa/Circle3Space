const n = {
  ...
  defaultdialogs: {
    ...
    confirmdelete: (e) => `Er du sikker på at du vil slette${e ? ` <strong>${e}</strong>` : ""}?`,
  ...
  general: {
    ...
    duration: (e, t, r) => new Date(t).getTime() < new Date(r).getTime() ? `for ${e} siden` : `om ${e}`
  },
  colors: {
    blue: "Blå"
  },
...
<span style="color: Red; font-weight: bold;">Bemærk:</span> at dokumenter og medier som afhænger af denne pakke vil muligvis holde op med at virke, så vær forsigtig. Hvis i tvivl, kontakt personen som har udviklet pakken.`,
  ...
  user: {
    ...
    createUserHeadline: (e) => e === "Api" ? "Opret API bruger" : "Opret bruger",
    ...
    selectUserGroup: (e) => e ? "Vælg brugergrupper" : "Vælg brugergruppe",
    chooseUserGroup: (e) => e ? "Vælg brugergrupper" : "Vælg brugergruppe",
    ...
    emailDescription: (e) => e ? "Emailadressen bruges som brugernavn og til notifikationer og adgangskode gendannelse" : "Emailadressen bruges til notifikationer og adgangskode gendannelse",
  ...
  references: {
    ...
    labelMoreReferences: (e) => e === 1 ? "...og en mere" : `...og ${e} andre`
  },
  logViewer: {
  ...
  blockEditor: {
    ...
    createThisFor: (e, t) => t ? `Opret ${e} for ${t}` : `Create ${e}`,
...
//# sourceMappingURL=da-dk-BNVUfhFR.js.map
