...
import { UmbId as g } from "@umbraco-cms/backoffice/id";
import { firstValueFrom as O } from "@umbraco-cms/backoffice/external/rxjs";
...
}, c = (a, t, e) => t.has(a) || m("Cannot " + e), D = (a, t, e) => (c(a, t, "read from private field"), t.get(a)), q = (a, t, e) => t.has(a) ? m("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(a) : t.set(a, e), R = (a, t, e, r) => (c(a, t, "write to private field"), t.set(a, e), e), p;
let n = class extends f {
  constructor() {
    super(), q(this, p), this.consumeContext(y, (a) => {
      R(this, p, a), this.observe(a.isNew, (t) => {
        this._isNew = t;
      }), this.observe(a.name, (t) => {
        this._name = t;
      }), D(this, p)?.createPropertyDatasetContext(this);
    });
  }
  render() {
...
class z extends C {
  constructor(t, e) {
    ...
    const r = e.manifest;
    this.#s = r.meta?.entityType, this.validationgContext = new N(this), this.addValidationContext(this.validationgContext), this.observe(this.unique, (s) => {
      s && this.validationgContext.setDataPath(d({ id: s }));
  ...
  async submit() {
    ...
    if (await this.#a, this.#e)
      this.validationgContext.report(), await this.#e.structure.insertProperty(t, e), this.setIsNew(!1);
    else
...
//# sourceMappingURL=property-type-workspace.context-CDWAV6wH.js.map
