import { css as y, query as C, state as d, customElement as $, html as u, repeat as w, nothing as k } from "@umbraco-cms/backoffice/external/lit";
import { umbracoColors as I, extractUmbColorVariable as E } from "@umbraco-cms/backoffice/resources";
import { umbFocus as M } from "@umbraco-cms/backoffice/lit-element";
...
import { U } from "./icon-registry.context-token-DEouUoS2.js";
...
let i = class extends z {
  constructor() {
    super(), f(this, a), f(this, s), this._colorList = I.filter((e) => !e.legacy), this._currentColor = "text", this.consumeContext(U, (e) => {
    ...
    this._colorList.map(
      (e) => u`
									<uui-color-swatch
										...
										title=${e.alias}
										value=${e.alias}
										style="--uui-swatch-color: var(${e.varName})"></uui-color-swatch>
								`
    )}
					</uui-color-swatches>
					<hr />
    ...
    return this._iconsFiltered ? w(
      ...
      (e) => u`
						<uui-button
							...
							<uui-icon
								style="--uui-icon-color: var(${E(this._currentColor)})"
...
//# sourceMappingURL=icon-picker-modal.element-DwbNcyPO.js.map
