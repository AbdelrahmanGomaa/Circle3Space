const n = {
  ...
  entityDetail: {
    notFoundTitle: (e) => `${e ?? "Item"} not found`,
    notFoundDescription: (e) => `The requested ${e ?? "item"} could not be found. Please check the URL and try again.`
  },
  media: {
...
//# sourceMappingURL=en-us-CYQSRBwH.js.map
