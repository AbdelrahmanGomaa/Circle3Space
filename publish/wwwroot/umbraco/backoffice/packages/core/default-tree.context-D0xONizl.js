...
import { UmbSelectionManager as y, UmbPaginationManager as E, debounce as R } from "@umbraco-cms/backoffice/utils";
...
class A extends m {
  constructor(t) {
    super(t, T), this.#t = new a({}), this.additionalRequestArgs = this.#t.asObservable(), this.#e = new a(void 0), this.treeRoot = this.#e.asObservable(), this.#s = new l([], (e) => e.unique), this.rootItems = this.#s.asObservable(), this.selectableFilter = () => !0, this.filter = () => !0, this.selection = new y(this._host), this.pagination = new E(), this.expansion = new v(this._host), this.#r = new o(!1), this.hideTreeRoot = this.#r.asObservable(), this.#h = new o(void 0), this.expandTreeRoot = this.#h.asObservable(), this.#u = new a(void 0), this.startNode = this.#u.asObservable(), this.#a = new o(!1), this.foldersOnly = this.#a.asObservable(), this.#n = {
      skip: 0,
      take: 50
    ...
    }, this.pagination.setPageSize(this.#n.take), this.#v(), this.pagination.addEventListener(x.TYPE, this.#E), this.#c();
  }
  #t;
  #e;
  #s;
...
export {
  A as UmbDefaultTreeContext,
  A as api
};
//# sourceMappingURL=default-tree.context-D0xONizl.js.map
