const n = {
  ...
  defaultdialogs: {
    ...
    confirmdelete: (e) => `Are you sure you want to delete${e ? ` <strong>${e}</strong>` : ""}?`,
    ...
    confirmTrash: (e) => `Are you sure you want to move <strong>${e}</strong> to the Recycle Bin?`,
    confirmBulkTrash: (e) => `Are you sure you want to move <strong>${e} ${e === 1 ? "item" : "items"}</strong> to the Recycle Bin?`,
    confirmBulkDelete: (e) => `Are you sure you want to delete <strong>${e} ${e === 1 ? "item" : "items"}</strong>?`,
    cut: "Cut",
  ...
  dictionary: {
    importDictionaryItemHelp: `To import a dictionary item, find the ".udt" file on your computer by clicking the "Add" button (you'll be asked for confirmation on the next screen).`,
  ...
  general: {
    ...
    duration: (e, t, o) => new Date(t).getTime() < new Date(o).getTime() ? `${e} ago` : `in ${e}`
  },
  colors: {
    blue: "Blue"
  },
...
To manage your website, simply open the Umbraco backoffice and start adding content, updating the templates and stylesheets or add new functionality`,
  ...
  contentPicker: {
    ...
    unsupportedHeadline: (e) => `<strong>Unsupported ${e ?? "content"} items</strong><br>The following content is no longer supported in this Editor.`,
    unsupportedMessage: "If you still require this content, please contact your administrator. Otherwise you can remove it.",
  ...
  user: {
    ...
    createUserHeadline: (e) => e === "Api" ? "Create API user" : "Create user",
    createUserDescription: (e) => e === "Api" ? "Create an Api User to allow external services to authenticate with the Umbraco Management API." : "Create a user to give them access to Umbraco. When a user is created a password will be generated that you can share with them.",
    changePassword: "Change your password",
    changePhoto: "Change photo",
    configureMfa: "Configure MFA",
    emailRequired: "Required - enter an email address for this user",
    emailDescription: (e) => e ? "The email address is used for notifications, password recovery, and as the username for logging in" : "The email address is used for notifications and password recovery",
    kind: "Kind",
    ...
    selectUserGroup: (e) => e ? "Select User Groups" : "Select User Group",
    chooseUserGroup: (e) => e ? "Choose User Groups" : "Choose User Group",
  ...
  references: {
    ...
    labelMoreReferences: (e) => e === 1 ? "...and one more item" : `...and ${e} more items`
  },
  logViewer: {
  ...
  blockEditor: {
    ...
    createThisFor: (e, t) => t ? `Create ${e} for ${t}` : `Create ${e}`,
    ...
    blockVariantConfigurationNotSupported: "One or more Block Types of this Block Editor is using a Element-Type that is configured to Vary By Culture or Vary By Segment. This is not supported on a Content item that does not vary by Culture or Segment."
  },
...
//# sourceMappingURL=en-jmfRFdeN.js.map
