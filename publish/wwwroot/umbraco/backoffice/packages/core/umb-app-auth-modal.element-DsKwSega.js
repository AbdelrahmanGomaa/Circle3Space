import "./modal-manager.context-DPpuCk7K.js";
import "@umbraco-cms/backoffice/class-api";
import "./confirm-modal.element-COhIMOef.js";
import { U as h } from "./discard-changes-modal.element-Ds5HOoV9.js";
...
import { UMB_APP_CONTEXT as _ } from "@umbraco-cms/backoffice/app";
var w = Object.defineProperty, x = Object.getOwnPropertyDescriptor, u = (e) => {
  throw TypeError(e);
}, g = (e, o, t, a) => {
  for (var r = a > 1 ? void 0 : a ? x(o, t) : o, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (a ? n(o, t, r) : n(r)) || r);
  return a && r && w(o, t, r), r;
}, y = (e, o, t) => o.has(e) || u("Cannot " + t), k = (e, o, t) => (y(e, o, "read from private field"), t ? t.call(e) : o.get(e)), U = (e, o, t) => o.has(e) ? u("Cannot add the same private member more than once") : o instanceof WeakSet ? o.add(e) : o.set(e, t), c;
...
//# sourceMappingURL=umb-app-auth-modal.element-DsKwSega.js.map
